...
<div class="register-box">
  <div class="register-logo">
    <a href="index2.html"><b>Si</b>PembaLab</a>
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
        ...
        <!-- <div class="form-group has-feedback">
          <input placeholder="NIS/NIP" type="number" class="form-control{{ $errors->has('nisp') ? ' is-invalid' : '' }}" name="nisp" value="{{ old('nisp') }}" required autofocus>

            @if ($errors->has('nisp'))
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('nisp') }}</strong>
                </span>
            @endif
        </div>
        <div class="form-group has-feedback">
          <input placeholder="Jurusan/MaPel" type="text" class="form-control{{ $errors->has('jurusan_mapel') ? ' is-invalid' : '' }}" name="jurusan_mapel" value="{{ old('jurusan_mapel') }}" required autofocus>

            @if ($errors->has('jurusan_mapel'))
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('jurusan_mapel') }}</strong>
                </span>
            @endif
        </div>
        <div class="form-group has-feedback">
          <input placeholder="No Hp" type="number" class="form-control{{ $errors->has('nohp') ? ' is-invalid' : '' }}" name="nohp" value="{{ old('nohp') }}" required autofocus>
        ...
        <div class="form-group has-feedback">
          <input placeholder="alamat" type="text" class="form-control{{ $errors->has('alamat') ? ' is-invalid' : '' }}" name="alamat" value="{{ old('alamat') }}" required autofocus>
